...
function tableContent() {
  ...
  document.getElementById('contentTable').innerHTML = "<tr><th>Add the jumbled sentences here.</th></tr>" + table1 + '    <button type="button" onclick="tableOrder()">Go!</button>';
}
function tableOrder() {
  var table3 = "";
  for (var i = 0; i < document.getElementById('collumn').value; i++) {
  ...
  document.getElementById('orderTable').innerHTML = "<tr><th>Type the order of the cells here.</th></tr>" +  table3 + '    <button type="button" onclick="read()">Go!</button>';;
}
function read() {
